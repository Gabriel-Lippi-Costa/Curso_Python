...
def calcular_desvio_padrao_amostral(conjunto_valores, media_conjunto_valores):
    soma_desvio = 0
...
resultado_desvio, resultado_desvio_quadrado, lista_desvios, lista_desvios_quadrados = calcular_desvio_padrao_amostral(conjunto_valores, resultado_media_conjunto)
...
print(f"Esse é o seu desvio padrão: {round(math.sqrt(resultado_desvio_quadrado / len(conjunto_valores)))}")